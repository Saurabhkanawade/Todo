...
type Task struct {
	...
	TodoListID  string      `boil:"todo_list_id" json:"todo_list_id" toml:"todo_list_id" yaml:"todo_list_id"`
	...
	Ppriority   null.String `boil:"ppriority" json:"ppriority,omitempty" toml:"ppriority" yaml:"ppriority,omitempty"`
...
var TaskTableColumns = struct {
	...
	ID:          "tasks.id",
	TodoListID:  "tasks.todo_list_id",
	Title:       "tasks.title",
	Description: "tasks.description",
	DueDate:     "tasks.due_date",
	Ppriority:   "tasks.ppriority",
	Status:      "tasks.status",
...
var TaskWhere = struct {
	...
	TodoListID  whereHelperstring
	Title       whereHelperstring
	Description whereHelpernull_String
	DueDate     whereHelpernull_Time
	Ppriority   whereHelpernull_String
	Status      whereHelpernull_String
	CreatedAt   whereHelpernull_Time
	UpdatedAt   whereHelpernull_Time
}{
	ID:          whereHelperstring{field: "\"tasks\".\"id\""},
	TodoListID:  whereHelperstring{field: "\"tasks\".\"todo_list_id\""},
	...
	Ppriority:   whereHelpernull_String{field: "\"tasks\".\"ppriority\""},
...
type taskR struct {
	TodoList *TodoList    `boil:"TodoList" json:"TodoList" toml:"TodoList" yaml:"TodoList"`
...
func (r *taskR) GetTodoList() *TodoList {
	if r == nil {
		return nil
	}
	return r.TodoList
...
func (r *taskR) GetTaskTags() TaskTagSlice {
	if r == nil {
		return nil
	}
	return r.TaskTags
...
var (
	taskAllColumns            = []string{"id", "todo_list_id", "title", "description", "due_date", "ppriority", "status", "created_at", "updated_at"}
	taskColumnsWithoutDefault = []string{"id", "todo_list_id", "title"}
	taskColumnsWithDefault    = []string{"description", "due_date", "ppriority", "status", "created_at", "updated_at"}
...
// TodoList pointed to by the foreign key.
func (o *Task) TodoList(mods ...qm.QueryMod) todoListQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.TodoListID),
	}

	queryMods = append(queryMods, mods...)

	return TodoLists(queryMods...)
}

// TaskTags retrieves all the task_tag's TaskTags with an executor.
func (o *Task) TaskTags(mods ...qm.QueryMod) taskTagQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"task_tags\".\"task_id\"=?", o.ID),
	)

	return TaskTags(queryMods...)
}

// LoadTodoList allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (taskL) LoadTodoList(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	if singular {
		...
		args = append(args, object.TodoListID)
	...
	Outer:
		for _, obj := range slice {
			...
			args = append(args, obj.TodoListID)
	...
	query := NewQuery(
		qm.From(`todo_list`),
		qm.WhereIn(`todo_list.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load TodoList")
	}

	var resultSlice []*TodoList
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice TodoList")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for todo_list")
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.TodoListID == foreign.ID {
				local.R.TodoList = foreign
				if foreign.R == nil {
					foreign.R = &todoListR{}
				}
...
func (taskL) LoadTaskTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTask interface{}, mods queries.Applicator) error {
	var slice []*Task
	var object *Task
	...
	query := NewQuery(
		qm.From(`task_tags`),
		qm.WhereIn(`task_tags.task_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetTodoList of the task to the related item.
// Sets o.R.TodoList to related.
// Adds o to related.R.Tasks.
func (o *Task) SetTodoList(ctx context.Context, exec boil.ContextExecutor, insert bool, related *TodoList) error {
	var err error
	if insert {
	...
	o.TodoListID = related.ID
	if o.R == nil {
		o.R = &taskR{
			TodoList: related,
		}
	} else {
		o.R.TodoList = related
	}
...
func (o *Task) AddTaskTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TaskTag) error {
	var err error
